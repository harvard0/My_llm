...
def grpo_train_epoch(
    ...
    for step, batch in enumerate(loader, start=start_step + 1):
        ...
        with torch.no_grad():
            ...
            outputs = model_for_gen.generate(  # type: ignore
                **prompt_inputs,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="MizukiMind GRPO (Group Relative Policy Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="MizukiMind-GRPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MizukiMind-GRPO-{'MoE' if args.use_moe else ''}-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
